        ...
        >
          ...
          >
            <div
              ...
              style={{
                padding: "1px",
                background: "linear-gradient(135deg, rgba(139,92,246,0.35), rgba(236,72,153,0.15), rgba(139,92,246,0.05))",
            ...
            <div className="relative rounded-2xl bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/[0.06] shadow-2xl shadow-black/60 overflow-hidden">
                  ...
                  <AnimatePresence>
                    {filteredNav.map((item, i) => (
                      <motion.button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/[0.04] text-left transition-all duration-150 group cursor-pointer"
                      >
                        <item.icon className="w-4 h-4 text-white/20 group-hover:text-violet-400 transition-colors" />
