    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center py-24 px-6 text-center">
          <div className="w-12 h-12 rounded-2xl bg-red-500/[0.08] border border-red-500/[0.12] flex items-center justify-center mb-5">
            <AlertTriangle className="w-6 h-6 text-red-400/70" />
          </div>
          <h2 className="text-lg font-semibold text-white/70 mb-2">Something went wrong</h2>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/[0.04] border border-white/[0.06] text-sm text-white/50 hover:text-white/70 hover:bg-white/[0.06] transition-all duration-200 cursor-pointer"
          >
