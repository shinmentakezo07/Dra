...
const productLinks = [
  { label: "Models", href: "/models", desc: "Browse 100+ AI models", accent: "bg-emerald-500" },
  { label: "Playground", href: "/playground", desc: "Test models in-browser", accent: "bg-blue-500" },
  { label: "Pricing", href: "/pricing", desc: "Credit-based billing", accent: "bg-amber-500" },
  { label: "Dashboard", href: "/dashboard", desc: "Usage analytics & keys", accent: "bg-violet-500" },
];
...
export function DocsNavbar({
  ...
  const accentHex = ACCENT_MAP[currentColor?.accent ?? "blue"] ?? ACCENT_MAP.blue;
        ...
        <header className="mx-auto max-w-6xl flex items-center h-[52px] px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="hidden sm:flex items-center gap-2">
              ...
              >
                <BookOpen className="w-3 h-3" style={{ color: accentHex, opacity: 0.8 }} />
              ...
              {currentSectionLabel && (
                <>
                  <span className="text-white/[0.08] text-[11px] font-light select-none">/</span>
                  <motion.span
                      ...
                      {productLinks.map((link) => (
                        ...
                        >
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-[11px] text-white/20 mt-0.5 leading-snug">{link.desc}</p>
                          </div>
                        </Link>
                      ))}
                    </div>
