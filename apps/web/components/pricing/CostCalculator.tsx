        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className={`w-1 h-4 rounded-full ${label.includes("Input") ? "bg-blue-500" : "bg-violet-500"}`} />
                    <span className="text-xs font-mono tracking-wide uppercase text-gray-400">{label}</span>
                </div>
                <motion.span
                    key={value}
            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        left: `${percentage}%`,
                        x: "-50%",
                        boxShadow: isDragging ? thumbShadow : "0 0 8px rgba(255,255,255,0.1)",
                    }}
                                        ...
                                        {calculatorModels.map((m, i) => (
                                            ...
                                            >
                                                ...
                                                <span className={`text-[10px] font-mono font-bold tracking-wide ${
                                                    selectedModelIndex === i ? "text-white" : "text-gray-500 group-hover/btn:text-gray-300"
                                                }`}>
                                                    {m.name}
                                                </span>
                                                <span className="text-[9px] text-gray-600 font-mono">{m.provider}</span>
                                            </motion.button>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-1 flex-1">
                                        ...
                                        <div className="mt-4 p-3 rounded-xl bg-gradient-to-r from-white/[0.02] to-transparent border border-white/[0.04]">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="text-[10px] font-mono uppercase text-gray-500 tracking-wide">Model Rate</span>
                                                <div className="flex items-center gap-1.5">
                                                    {model.logo ? (
                                                        <Image src={model.logo} alt={model.provider} width={14} height={14} className="object-contain" unoptimized />
                                                    ) : (
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="text-center">
                                                    <div className="text-[9px] text-gray-600 font-mono uppercase">Input</div>
                                                    <div className="text-xs font-mono font-bold text-blue-400">{model.inputPricePer1k}</div>
                                                    <div className="text-[9px] text-gray-600 font-mono">/1K tokens</div>
                                                </div>
                                                <ArrowRight className="w-3 h-3 text-gray-600" />
                                                <div className="text-center">
                                                    <div className="text-[9px] text-gray-600 font-mono uppercase">Output</div>
                                                    <div className="text-xs font-mono font-bold text-violet-400">{model.outputPricePer1k}</div>
                                                    <div className="text-[9px] text-gray-600 font-mono">/1K tokens</div>
                                                </div>
                                            </div>
                                        </div>
