...
export function MetricCard({
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${iconBg}`} />
      <div className="relative flex items-center justify-between mb-3">
        <div className={`p-2 rounded-lg ${iconBg} ${iconColor} group-hover:scale-110 group-hover:shadow-lg transition-all duration-300`}>
