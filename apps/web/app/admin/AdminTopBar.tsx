      ...
      <div className="flex items-center justify-between px-8 py-5">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {showNotif && (
                ...
                >
                  <div className="p-5">
                    <p className="text-[12px] text-[var(--admin-text-dim)] text-center">
          ...
          <div ref={menuRef} className="relative ml-1">
            ...
            >
              <div
                className="w-7 h-7 rounded-lg flex items-center justify-center ring-1 ring-white/[0.06]"
                style={{
                  background:
              ...
              {showUserMenu && (
                ...
                >
                  <div className="p-4 border-b border-white/[0.04]">
                    ...
                    <p className="text-[11px] text-[var(--admin-text-dim)] font-mono truncate mt-0.5">
                      admin@yapapa.io
                    </p>
                  </div>
