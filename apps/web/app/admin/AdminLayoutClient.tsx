...
export default function AdminLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div data-admin className="h-screen bg-[var(--admin-bg)] relative z-0 overflow-hidden">
      ...
      <AdminSidebar collapsed={collapsed} onCollapseAction={() => setCollapsed(!collapsed)} />
