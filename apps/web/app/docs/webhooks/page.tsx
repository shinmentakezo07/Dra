      ...
      <Section id="webhooks" icon={Webhook} title="Webhooks" accent="amber">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
          {[
            ...
            <div
              key={evt.event}
              className="p-4 rounded-xl bg-white/[0.01] border border-white/[0.05] hover:border-white/[0.1] transition-all duration-200"
            >
    ...
    Buffer.from(expected)
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div
              key={item.title}
              className="p-4 rounded-xl bg-white/[0.01] border border-white/[0.06] hover:border-white/[0.1] transition-colors duration-200"
            >
