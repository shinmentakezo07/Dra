      ...
      <Section id="rate-limits" icon={Shield} title="Rate Limits">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          {[
            ...
            <div key={stat.label} className="relative p-5 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center group hover:border-blue-500/[0.12] transition-all duration-300">
