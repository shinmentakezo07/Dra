      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#000000]">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full h-full">
          <div className="flex items-center justify-between">
            <Link
              href="/"
              className="text-2xl font-bold tracking-tighter text-white flex items-center gap-2 hover:opacity-80 transition-opacity"
            >
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-base mb-5 font-light">
              Join thousands of developers building with transparent,
            ...
            <div className="space-y-2.5 font-mono text-sm">
              {[
                ...
                <div key={i} className="flex items-center gap-3 group">
                  ...
                  <span className="text-gray-400 group-hover:text-gray-200 transition-colors text-xs">
                    {feature}
                  </span>
                </div>
              ))}
          ...
          <div className="flex items-center gap-4 p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm w-fit">
            ...
            <p className="text-gray-400 text-[10px] font-mono">
              <span className="text-white font-bold">50,000+</span> DEVELOPERS
              BUILDING
            </p>
          </div>
        </div>
          ...
          <div className="mb-6 p-6 rounded-2xl bg-[#0A0A0A] border border-white/10">
            ...
            <div className="relative mb-5">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-widest font-mono">
                <span className="px-4 bg-[#050505] text-gray-600">
