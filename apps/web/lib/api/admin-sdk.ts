...
import type {
  ...
  ProviderPlugin, RateLimitTier, RBACPermission, RBACRole, MessageStats, CostBreakdown,
} from "@/types/admin";


type AdminMessage = { id: string; title: string; body: string; priority: string; targetType: string; targetIds: string[]; sentBy: string; senderEmail: string; sentAt: string; expiresAt?: string; createdAt: string; readCount: number };
...
export class AdminSDK {
  ...
  async listUsers(params?: { query?: string; status?: string; page?: number; limit?: number }): Promise<PaginatedResult<AdminUserDetail>> {
    return this.api.adminListUsers(params?.page, params?.limit) as unknown as PaginatedResult<AdminUserDetail>;
  }
  ...
  async listTransactions(params?: { userId?: string; model?: string; page?: number; limit?: number }): Promise<PaginatedResult<UsageRecord>> {
    return this.api.adminListTransactions(params as Record<string, string | number | undefined>) as unknown as PaginatedResult<UsageRecord>;
  }
  ...
  async listAdjustments(userId: string, page?: number, limit?: number): Promise<PaginatedResult<CreditAdjustment>> {
    return this.api.adminListAdjustments(userId, page, limit) as unknown as PaginatedResult<CreditAdjustment>;
  }
  ...
  async listSuspicious(params?: { category?: string; severity?: string; page?: number; limit?: number }): Promise<PaginatedResult<SuspiciousActivity>> {
    return this.api.adminListSuspicious(params as Record<string, string | number | undefined>) as unknown as PaginatedResult<SuspiciousActivity>;
  }
  ...
  async listAuditLogs(params?: { actorId?: string; action?: string; targetType?: string; severity?: string; page?: number; limit?: number }): Promise<PaginatedResult<AuditLog>> {
    return this.api.adminListAuditLogs(params as Record<string, string | number | undefined>) as unknown as PaginatedResult<AuditLog>;
  }
  ...
  async listIPAccessLogs(params?: { limit?: number }): Promise<PaginatedResult<IPAccessLog>> {
    return this.api.adminListIPAccessLogs(params as Record<string, string | number | undefined>) as unknown as PaginatedResult<IPAccessLog>;
  }
  ...
  // Admin Messages
  async listMessages(page?: number, limit?: number): Promise<PaginatedResult<AdminMessage>> {
    return this.api.adminListMessages(page, limit) as unknown as PaginatedResult<AdminMessage>;
  }
  ...
  // Billing — Usage Daily
  async listUsageDaily(params?: { from?: string; to?: string; groupBy?: string }): Promise<UsageDaily[]> {
    return this.api.adminUsageDaily(params as Record<string, string | number | undefined>);
  }
  ...
  async updateTierLimits(tier: string, data: { rpm?: number; daily?: number; monthly?: number; maxTokens?: number }): Promise<void> {
